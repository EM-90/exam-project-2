...
export const venueAPI = {
    ...
    fetchVenueById(id: string, includeOwner: boolean = false, includeBookings: boolean = false) {
      ...
      return apiClient.get<ApiResponse<Venue>>(`/holidaze/venues/${id}?${queryParams.toString()}`);
    },
