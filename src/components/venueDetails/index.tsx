        ...
        <div>
          ...
          <ul className="flex flex-col md:flex-row list-none gap-5 md:gap-16 mb-8">
            <li className="font-medium text-lg">
              <span className="text-3xl align-middle text-skin-primary">${venueData.price}</span> Night
            </li>
            <li className="font-medium text-lg">
              <span className="text-3xl align-middle text-skin-primary font-medium">{venueData.maxGuests}</span> Guests
            </li>
            <li className="font-medium text-lg">
              <span className="text-3xl align-middle text-skin-primary font-medium">{venueData.rating}/5</span> Rating
            </li>
          </ul>
              ...
              <ul className="mt-4 flex gap-1 flex-wrap font-medium">
                <div className="flex flex-col gap-1">
                  <li className="bg-skin-infoBg px-3 py-1 text-skin-primary rounded-full border-skin-InputBorder border-2 flex gap-2 items-center">
                    <FaWifi size={20} className="text-skin-primary" />Wifi ({venueData.meta.wifi ? "Yes" : "No"})
                  </li>
                  <li className="bg-skin-infoBg px-3 py-1 text-skin-primary rounded-full border-skin-InputBorder border-2 flex gap-2 items-center">
                    <FaSquareParking size={20} className="text-skin-primary" />Parking ({venueData.meta.parking ? "Yes" : "No"})
                  </li>
                </div>
                <div className="flex flex-col gap-1">
                  <li className="bg-skin-infoBg px-3 py-1 text-skin-primary rounded-full border-skin-InputBorder border-2 flex gap-2 items-center">
                    <FaEgg size={20} className="text-skin-primary" />Breakfast included ({venueData.meta.breakfast ? "Yes" : "No"})
                  </li>
                  <li className="bg-skin-infoBg px-3 py-1 text-skin-primary rounded-full border-skin-InputBorder border-2 flex gap-2 items-center">
                    <FaCat size={20} className="text-skin-primary" />Pets allowed ({venueData.meta.pets ? "Yes" : "No"})
                  </li>
                </div>
              </ul>
            </section>
          ...
          <div className="my-8">
            <h3 className="text-xl font-bold mt-10 mb-4">Owner of this venue</h3>
